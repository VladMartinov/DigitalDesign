            ...
            <div class="task-item">
              <div class="task-item-content">
                <div class="task-item-content-row">
                  <p class="task-item__title text text_prim">${item.title}</p>

                  <div class="roject-item__profile profile-img">
                ...
                <div class="task-item-content-info">
                  ...
                  <span
                    class="task-content__status status-item status-item_${
                      item.info.tagStatus
                    } text"
              ...
              <div class="task-item-more">
                <div class="task-item-more__wrapper">
