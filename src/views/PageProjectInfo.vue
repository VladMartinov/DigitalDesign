<template>
  <div class="page__wrapper">
    <h1 class="text text_prim text_h1">Project info:</h1>
    
    <div class="page__info">
      <h2 class="text text_prim text_h2">Project id: {{ itemData._id }}</h2>
      <h2 class="text text_prim text_h2">Project title: {{ itemData.name }}</h2>
...
export default {
  ...
  methods: {
    ...
    updateItemData: function() {
      ...
      GETFunc(this.url + `/${this.projectId}`, token).then((responseData) => {
