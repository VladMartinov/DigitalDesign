      ...
      <div class="create-task__wrapper">
        ...
        <div class="create-task__actions">
          <div class="create-task__cancel">
            <BaseButton :title="'Отмена'" :hideIcon="true">Отмена</BaseButton>
          </div>

          <BaseButton :isPrim="true" :title="'Создать задачу'" @onButtonClick="onSendValue">Создать задачу</BaseButton>
        </div>
      </div>
    </div>
  </section>
