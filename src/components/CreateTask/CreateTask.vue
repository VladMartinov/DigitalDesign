      ...
      <div class="create-task__wrapper">
        ...
        <div class="create-task__actions">
          <div class="create-task__cancel">
            <BaseButton class="button__second" :title="'Отмена'" :hideIcon="true">Отмена</BaseButton>
          </div>

          <BaseButton class="button__primary" :title="'Создать задачу'" @onButtonClick="onSendValue">Создать задачу</BaseButton>
        </div>
      </div>
    </div>
  </section>
