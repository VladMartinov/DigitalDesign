<template>
  <div class="select-input__wrapper" v-click-outside="closeDropdown">
    <SelectButton :textPlaceholder="textPlaceholder" :isDisabled="isDisabled" :setValue="currentVal" :isActive="isOpened" :isProfileFilter="isProfile || isProfileSearch"  @onSelectButtonClick="changeStateSelectInput" @onClearValue="clearValue" :key="currentValId"></SelectButton>
