    ...
    <div class="section-login__wrapper">
      ...
      <div class="login__rows-wrapper">
        ...
        <div class="login__row">
          ...
          <InputPassword :isError="isErrorAuth" :isHideIcon="true" :currentVal="user.login" @onValueChanged="user.login = $event.value; isErrorAuth = false;"></InputPassword>
        </div>
        ...
        <div class="login__row">
          ...
          <InputPassword :isError="isErrorAuth" :currentVal="user.password" @onValueChanged="user.password = $event.value; isErrorAuth = false;"></InputPassword>
        </div>
      </div>
