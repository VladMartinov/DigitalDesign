<template>
  <div class="task__aside">
    ...
    <div class="task__aside-row">
      ...
      <InputSelect :isTag="true" :hideClearButton="true" :inputValueArray="tagsDropdownData" :currentValId="task.status" :isDisabled="(!currentUserRole.isAuthor && !currentUserRole.isExecutor &&!currentUserRole.isAdmin) || isDeleted" @onValueSelected="StatusChanged"></InputSelect>
    </div>
    <!-- // aside-row -->
