      ...
      <div class="container">
        <div class="header__wrapper">
          <nav class="header__nav">
            <BaseButton class="button__nav" :title="'Проекты'" data-typePage="projects" :isActive="activePageArray[0]" @onButtonClick="onNavClick"></BaseButton>
            <BaseButton class="button__nav" :title="'Задачи'" data-typePage="tasks" :isActive="activePageArray[1]" @onButtonClick="onNavClick"></BaseButton>
            <BaseButton class="button__nav" :title="'Пользователи'" data-typePage="profile" :isActive="activePageArray[2]" @onButtonClick="onNavClick"></BaseButton>
          </nav>
