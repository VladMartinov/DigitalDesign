  ...
  <div class="user-item">
    <div class="user-item-content">
      <div class="user-item-content__wrapper">
        ...
        <p class="text text_prim">{{ itemData.fullName }}</p>
      </div>

      <StatusTag v-if="itemData.tagStatus && itemData.tagText" :tagStatus="itemData.tagStatus" :tagText="itemData.tagText"></StatusTag>
    </div>
