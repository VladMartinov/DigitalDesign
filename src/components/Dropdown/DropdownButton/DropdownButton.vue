<template>
  <div class="dropdown-button" v-click-outside="closeDropdown">
    <BaseButton :class="validButtonClass" :title="title" :nameIcon="'arrow-bottom'" 
      :isActive="isActive" :isDisabled="isDisabled" 
      :hideText="hideText" :hideIcon="hideIcon" 
      @onButtonClick="changeStateDropdown"></BaseButton>
...
export default {
  ...
  computed: {
    validButtonClass() {
      return this.isPrim ? "button__primary" : "button__second"
    },
