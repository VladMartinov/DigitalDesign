  ...
  return `<div class="container">
            <div class="project-item">
              <div class="project-item-content">
                <div class="project-item-content__title">
                  <p class="text text_prim">${item.title}</p>
                </div>

                <div class="project-item-content-info">
                  <span class="project-content-info__id text text_prim">#${
                    item.info.id
                  }</span>

                  <p class="project-content-info__text text text_disabled">
                    ${item.info.author}
                  </p>
                  <p class="project-content-info__user-info text text_disabled">
              ...
              <div class="project-item-more">
                <div class="project-item-more-wrapper">
